<button type="button" wire:poll='contadorTarefas'
    ...
    <div class="flex">
        <svg class="h-6 w-6 {{ $qtdeTarefas ? 'text-red-600' : 'text-gray-300' }}" xmlns="http://www.w3.org/2000/svg"
        ...
        <span class='text-sm'>{{ $qtdeTarefas }}</span>
    </div>
</button>
